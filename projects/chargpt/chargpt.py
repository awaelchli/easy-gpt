...
def main():
    ...
    lite = LightningLite(accelerator="cuda", devices=4, precision=32, strategy=FSDPStrategy(auto_wrap_policy=auto_wrap_policy, cpu_offload=CPUOffload(offload_params=True)))
    lite.launch()
